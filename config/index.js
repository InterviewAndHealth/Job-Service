...
module.exports = {
  ...
  DATABASE_NAME: process.env.DATABASE_NAME || process.env.INTERVIEW_SERVICE_DB,
  ...
  SERVICE_NAME: process.env.SERVICE_NAME || "JOBS_SERVICE",
  SERVICE_QUEUE: process.env.SERVICE_QUEUE || process.env.JOBS_QUEUE,
  RPC_QUEUE: process.env.RPC_QUEUE || process.env.JOBS_RPC,
